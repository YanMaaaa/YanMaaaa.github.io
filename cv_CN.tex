...
{\footnotesize 860+ citations，相关科研项目累计 1.3k+ GitHub stars} \\ \vspace{2pt}
...
\section{论文发表}
  ...
  {我们提出了一个透明、可复现的 VLM 强化学习框架与轨迹级评测方式，并揭示了 RL 相对 SFT 更强的泛化与更清晰的训练动态。}
  \PaperTLDR
