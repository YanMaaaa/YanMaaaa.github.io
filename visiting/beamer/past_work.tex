...
\begin{frame}[label=short-paper1-start]{\Large Starting with Visual Reasoning RL}
  \centering
  \vspace{-0.50cm}
...
\begin{frame}[label=short-paper1-dynamics]{\Large What Does RL Change During Multimodal Reasoning Training?}
  \centering
  \vspace{0.05cm}
...
\begin{frame}[label=short-paper2-start]{\Large From Visual Reasoning to Perception + Reasoning}
  \centering
  \vspace{-0.40cm}
  {\fontsize{11}{11}\selectfont
...
\begin{frame}[label=short-paper2-evidence]{\Large Can Multimodal RL Jointly Shape Perception and Reasoning?}
  \centering
  \vspace{0.24cm}
...
\begin{frame}[label=short-paper3-start]{\Large From Perception + Reasoning to Acting Through Tools}
  \centering
  \vspace{-0.40cm}
  {\fontsize{11}{11}\selectfont
...
\begin{frame}[label=short-paper3-intrinsic]{\Large Do Gains Come From Tool Use or Intrinsic Learning?}
  \begin{columns}[T,onlytextwidth]
...
\begin{frame}[label=short-paper3-future-target]{\Large What Should Future Tool-Use RL Learn?}
  \begin{columns}[T,onlytextwidth]
