...
\begin{frame}[label=short-why-video]{\Large Why Video for Predictive Multimodal Learning?}
  \centering
  \vspace{0.20cm}
...
\begin{frame}[label=short-video-data-foundations]{\Large Video Data Foundations for Predictive Multimodal Learning}
  \centering
  \vspace{0.18cm}
...
\begin{frame}[label=short-future-vision]{\Large Future Vision: Three Generations of Multimodal Agents}
  \centering
  \vspace{0.04cm}
  \includegraphics[
  ...
  \begin{tikzpicture}
    ...
    \node[align=center] at (-0.38,0.) {
      ...
      {\fontsize{7.0}{7}\selectfont anticipate changes, guide decisions}
    };
  ...
  \textbf{From desktops, to live real-world streams, to physical bodies:}
  \textcolor{PredictColor}{\textbf{prediction}} becomes central.}
\end{frame}
